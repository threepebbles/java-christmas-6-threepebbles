...
public class OutputView {
    ...
    public static final String ORDER_FORMAT = """
            <주문 메뉴>
            %s""";
    public static final String TOTAL_PRICE_BEFORE_DISCOUNT_FORMAT = """
            <할인 전 총주문 금액>
            %s""";
    public static final String GIFT_FORMAT = """
            <증정 메뉴>
            %s""";
    public static final String DISCOUNT_DETAILS_FORMAT = """
            <혜택 내역>
            %s""";
    public static final String TOTAL_DISCOUNT_FORMAT = """
            <총혜택 금액>
            %s""";
    public static final String EXPECTED_PAY_AFTER_DISCOUNT_FORMAT = """
            <할인 후 예상 결제 금액>
            %s""";
    public static final String EVENT_BADGE_FORMAT = """
            <12월 이벤트 배지>
            %s""";
